...
- Current code state: the resumable pipeline and frontend are published; incomplete runs now report `partial` instead of `complete`, and missing records keep their failure reason.
